        ...
        <Col xs="5" className="p-0">     
            ...
            <div>
                <div>
                    ...
                    <img className="img-fluid for-light" src={require("../../assets/images/logo/logo.svg")} alt="looginpage"/>
                    <img className="img-fluid for-dark" src={require("../../assets/images/logo/logo_dark.svg")} alt="looginpage"/></a>
                </div>
