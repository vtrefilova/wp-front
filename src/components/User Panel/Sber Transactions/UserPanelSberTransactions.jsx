...
import './UserPanelSberTransactions.scss';
import API_getUserSberTransactions from '../../../api/getUserSberTransactions';

const UserPanelSberTransactions = ({
    user
}) => {
    ...
    const getTransactions = async () => {
        const data = await API_getUserSberTransactions(user.id, page - 1, 10);
    ...
    return (
        <>
            <Card>
                <CardHeader>
                    <h6 className="card-title mb-0">Транзакции Сбер</h6>
                </CardHeader>
...
export default UserPanelSberTransactions;