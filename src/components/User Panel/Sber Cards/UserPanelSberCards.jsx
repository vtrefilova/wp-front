...
import API_getUserSberCards from '../../../api/getUserSberCards';

import './UserPanelSberCards.scss';

const UserPanelSberCards = ({
    user
}) => {
    ...
    const getCards = async () => {
        const data = await API_getUserSberCards(user.id);
    ...
    return (
        <>
            <Card>
                <CardHeader>
                    <h6 className="card-title mb-0">Карты Сбер</h6>
                </CardHeader>
...
export default UserPanelSberCards;